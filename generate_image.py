...
def run():
    ...
    try:
        ...
        prompt_text = f"/createimage: Generate a photorealistic or artistic editorial image with a size strictly of 1328x1184 px at a 1:1 aspect ratio. The image should serve as a compelling LinkedIn post visual — no text, no overlays, no logos. Depict the following scene in high detail and cinematic quality: {prompt}"
