...
# --- NEW HF REWRITE FUNCTION ---
def rewrite_with_hf(text):
    print("[AI] Rewriting description with HuggingFace...", flush=True)

    prompt = (
        f"Task: Rewrite the legal content below into a high-engagement LinkedIn post of approximately 120 words.\n"
        f"Rules:\n"
        f"1. Structure: Exactly two paragraphs. First paragraph must be a bold 'Hook'. Second paragraph should be the 'Body'.\n"
        f"2. End with a question.\n"
        f"3. SEO friendly language.\n"
        f"4. No intro/outro.\n"
        f"5. No special symbols like * or **.\n"
        f"6. Use one blank line between paragraphs.\n"
        f"7. IMPORTANT: At the end of the post, include 5 to 10 relevant and professional hashtags for SEO. Place them on a new line after the content. Do not include any extra explanation.\n"
        f"Content: {text}"
    )
